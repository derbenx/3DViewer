const APP_PREFIX = 'mview-cache-';
    const PRECACHE_ASSETS = [
        ...
        'version.json',
        'js/hands.js',
        'js/gltf-transform/core.js',
        'js/gltf-transform/extensions.js',
        'js/gltf-transform/functions.js',
        'js/ktx-parse/ktx-parse.js',
        'js/property-graph/property-graph.js',
        'js/buffer/buffer.js',
        'js/ndarray/ndarray.js',
        'js/ndarray-pixels/ndarray-pixels.js',
        'js/ndarray-lanczos/ndarray-lanczos.js',
